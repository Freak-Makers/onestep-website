    ...
    <header className="relative pt-20 md:pt-32 pb-16 md:pb-20 overflow-hidden bg-white dark:bg-background-dark">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-3xl">
          ...
          <p className="text-base md:text-xl text-slate-600 dark:text-slate-400 mb-8 md:mb-10 leading-relaxed">
            시장의 흐름을 읽고 본질에 집중하는 전문가 그룹이 함께합니다.<br className="hidden md:block" />
            지속 가능한 성장을 설계하는 원스텝 컨설팅입니다.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            <Link href="/contact" className="bg-primary text-white px-8 py-4 rounded-lg font-bold text-lg hover:shadow-xl hover:-translate-y-1 transition-all text-center">
              무료 컨설팅 시작하기
            </Link>
            <Link href="/portfolio" className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-slate-50 transition-all text-center">
              포트폴리오 보기
            </Link>
          </div>
        </div>
