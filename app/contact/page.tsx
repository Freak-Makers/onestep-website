...
export default function ContactPage() {
  return (
    <>
      <Navbar />
      <header className="relative pt-32 pb-20 overflow-hidden bg-slate-50 dark:bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-1/2">
              ...
              <h1 className="text-4xl md:text-5xl font-extrabold leading-tight mb-6 text-slate-900 dark:text-white">
                전문적인 컨설팅으로<br />
                <span className="text-primary">비즈니스의 해답</span>을 찾으세요.
              </h1>
              <p className="text-lg text-slate-600 dark:text-slate-400 mb-8 leading-relaxed">
                단순한 대행을 넘어 브랜드의 가치를 발견하고<br />
              ...
              <div className="flex items-center gap-6">
                ...
                <p className="text-sm text-slate-500 font-medium">1,367개 이상의 기업이<br />선택한 마케팅 전문가 팀</p>
              </div>
            </div>
            <div className="lg:w-1/2">
      ...
      <main className="py-24 bg-white dark:bg-background-dark">
